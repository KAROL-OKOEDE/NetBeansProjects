...
public class Webcam extends javax.swing.JFrame {
    ...
    static {
        File file = new File("C:\\Users\\LENOVO\\Documents\\NetBeansProjects\\CBT test\\src\\folder\\opencv_java249.dll");
                ...
                while (runnable) {
                    if (websource.grab()) {
                        try {
                            ...
                            if (g.drawImage(buff, 1, 1, jLabel2.getHeight(), jLabel2.getWidth(), null));
                            {
                                if (runnable == false) {
                                    this.wait();
                                }
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(loginPage.jLabel31.getWidth(), loginPage.jLabel31.getHeight(), Image.SCALE_DEFAULT));
                loginPage.jLabel31.setIcon(imageico);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                loginPage.jTextField4.setText(Filename);
                File omage = new File(Filename);
                FileInputStream fis = new FileInputStream(omage);
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
                byte[] Byte = new byte[1024];
                for (int i; (i = fis.read(Byte)) != -1;) {
                    baos.write(Byte, 0, i);
                }
                loginPage.photo = baos.toByteArray();
                dispose();
            } catch (Exception e) {
                stopCam();
                JOptionPane.showMessageDialog(rootPane, "Warning");
