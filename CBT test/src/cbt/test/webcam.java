...
public class webcam extends javax.swing.JFrame {
                ...
                while (runnable) {
                    if (websource.grab()) {
                        try {
                            ...
                            if (g.drawImage(buff, 1, 1, jLabel1.getHeight(), jLabel1.getWidth(), null));
                            {
                                if (runnable == false) {
                                    this.wait();
                                }
    ...
    private void CaptureImage(JLabel imageic) {
        try {
            stopCam();
            if (getImage != null) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                image.jTextField4.setText(Filename);
